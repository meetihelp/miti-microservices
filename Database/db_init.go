...
func init() {
	...
	db_credentials:=fmt.Sprintf("sslmode=require user=doadmin host=db-postgresql-blr1-60587-do-user-3919569-0.db.ondigitalocean.com dbname=production port=25061  sslmode=require binary_parameters=yes sslrootcert=/home/gaurav/Downloads/do/ca-certificate.crt password="+postgres_password)
