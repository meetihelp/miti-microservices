...
func EnterBoardContent(userId string,boardId string,text string,imageId string,contentId string,requestId string,createdAt string) string{
	db:=database.GetDB()
